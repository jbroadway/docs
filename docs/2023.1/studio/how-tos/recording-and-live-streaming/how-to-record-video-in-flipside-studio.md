...
> **Note:** If you're using the desktop version of Flipside Studio, you can skip to **Step 5.** and capture Flipside Studio directly in OBS, unless you want to capture on a separate machine than the one you're using for VR.
